...
const { register, loginUser, logoutUser, getAllUsers, getUserById, jwtEncodedToken } = require("../controllers/users.controller");
...
router.route("/auth/token").post(jwtEncodedToken);
